...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
            ...
            var q_readonly = [];
            var bbmNum = [];
            var bbmMask = [['txtBirthday','999/99/99'],['txtTakeofficedate','999/99/99'],['txtLeaveofficedate','999/99/99']];
            q_sqlCount = 6;
            brwCount = 6;
            brwList = [];
            brwNowPage = 0;
            ...
            aPop = new Array(['txtTggno', 'lblTgg', 'tgg', 'noa,comp', 'txtTggno,txtTgg', 'tgg_b.aspx']
                ...
                , ['txtAddr_conn', '', 'view_road', 'memo,zipcode', '0txtAddr_conn,txtZip_conn', 'road_b.aspx']);
            ...
            <div class="dbbm">
                <table class="tbbm"  id="tbbm">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input id="txtTggno" type="text" style="float:left;width:35%;"/>
                            <input id="txtTgg" type="text" style="float:left;width:65%;"/>
                        </td>
                    </tr>
                    <tr>
